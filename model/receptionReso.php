...
class ReceptionReso {
    ...
    function creerReceptionReso($i,$n,$s, $np, $dd, $dr, $t,$nt,$d,$c,$a) {
     ...
     function nouvelleReso($num,$sujet, $projet, $note,$departement, $ugp) {
        $bdd = new ConnexionBDD();
        $date= date("Y-m-d");
        $sql = "INSERT INTO receptionReso (NumReception, Sujet, NumProjet_id, DateDemande,Notes,Departement_id,codeUgp_id) VALUES ('$num','$sujet','$projet','$date','$note','$departement','$ugp')";
        $msg='';
