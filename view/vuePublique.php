...
<table class="table3">
    ...
    public function afficherFormulaireCour() {
        ...
        <h1> Renseignement sur le cours :</h1><br><br>
          <label for="sigle">Sigle du cours : </label>
        ...
        <label for="cycle">Cycle du cours : </label>
    ...
    public function afficherFormulaireProgramme($ugp) {
        ...
        <h1> Renseignement sur le Programme:</h1><br><br>
          <label for="sigle">Code du programme :</label>
        ...
        <label for="type">Type de programme (facultatif) :</label>
